var Box = require('./api/box/box.model'),
    Device = require('./api/device/device.model'),
    Execution = require('./api/execution/execution.model'),
    ExecutionStatus = require('./api/execution-status/execution-status.model'),
    HealthCheck = require('./api/health-check/health-check.model'),
    Job = require('./api/job/job.model'),
    JobType = require('./api/job-type/job-type.model'),
    Script = require('./api/script/script.model'),
